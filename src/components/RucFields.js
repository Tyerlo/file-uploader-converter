...
const DropDownRuc = ({ props }) => {
	...
	return (
		<div>
			{props.values.selectRuc === "Plan 1" ? ruc1 : null}
			{props.values.selectRuc === "Plan 2" ? (
				<Fragment>
					{ruc1}
					{ruc2}
				</Fragment>
			) : null}
			{props.values.selectRuc === "Plan 3" ? (
				<Fragment>
					{ruc1}
					{ruc2}
					{ruc3}
