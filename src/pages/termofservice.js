...
const termofservice = () => {
  return (
    <div>
      ...
      these terms and conditions. Do not continue to use Website Name if you do
      ...
      use of cookies. By accessing Website Name, you agreed to use cookies in
      agreement with the Company Name's Privacy Policy. Most interactive
      ...
      conditions. You must not: Republish material from Website Name Sell, rent
      or sub-license material from Website Name Reproduce, duplicate or copy
      material from Website Name Redistribute content from Website Name This
      ...
      certain areas of the website. Company Name does not filter, edit, publish
      ...
      Company Name shall not be liable for the Comments or for any liability,
      ...
      Company Name reserves the right to monitor all Comments and to remove any
      ...
      activity. You hereby grant Company Name a non-exclusive license to use,
      ...
      visibility of the hyperlink compensates the absence of Company Name; and
      ...
      our website, you must inform us by sending an e-mail to Company Name.
      ...
      Company Name's logo or other artwork will be allowed for linking absent a
